      ...
      <ul class="sidebar-menu">
        ...
        <li>
          <a href="<?php echo site_url('home/admin');?>">
            <i class="fa fa-dashboard text-yellow"></i> <span>Beranda</span>
          </a>
      </li>
      <li>
        ...
        <li>
          <a href="<?php echo site_url('galeri')?>" >
            <i class="fa fa-file-video-o text-blue"></i> <span>Galeri</span>
          </a>
        </li>
        <li>
          <a href="<?php echo site_url('gambar')?>" >
            <i class="fa fa-file-image-o text-green"></i> <span>Gambar Utama</span>
          </a>
        </li>
        <li>
          <a href="<?php echo site_url('pengumuman')?>" >
            <i class="fa fa-book text-orange"></i> <span>Pengumuman</span>
          </a>
        </li>
        <li>
